...
- (void)sendRequestTo:(NSURL*)url usingVerb:(NSString*)verb withParameters:(NSDictionary*)parameters andHeaders:(NSDictionary*)extraHeaders
{
        NSData *body = nil;
        ...
        [NSURLRequest setAllowsAnyHTTPSCertificate:YES forHost:[finalURL host]];
